...
partial class Resource
{
    public static Resource FromSnapshot(ResourceSnapshot snapshot)
    {
        ...
        {
            resource.Commands.Add(new ResourceCommand { CommandType = command.Type, DisplayName = command.DisplayName, IconContent = command.IconContent, IsHighlighted = command.IsHighlighted, State = MapCommandState(command.State) });
        }
